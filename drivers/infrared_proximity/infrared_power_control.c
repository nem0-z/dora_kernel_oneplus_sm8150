			                               ...
			                               const char* buff, size_t count)
{
	...
	INFRARED_LOG("infrared_power_enable : %d, enable : %ld", g_infrared_state->infrared_power_enable, enable);
			                               ...
			                               const char* buff, size_t count)
{
  unsigned long infrared_shut_down_state = 0;
	...
	INFRARED_LOG("infrared_shut_down_state : %ld", infrared_shut_down_state);
