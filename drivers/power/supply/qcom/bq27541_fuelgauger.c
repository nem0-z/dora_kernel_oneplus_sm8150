...
static void bq27411_modify_soc_smooth_parameter(struct bq27541_device_info *di,
		bool is_powerup);
...
static void update_battery_soc_work(struct work_struct *work)
{
	...
	if (!bq27541_di->already_modify_smooth)
		schedule_delayed_work(&bq27541_di->modify_soc_smooth_parameter,
...
static bool bq27411_check_soc_smooth_parameter(struct bq27541_device_info *di,
		bool is_powerup)
{
	int value_read = 0;
