...
static void _retire_timestamp(struct kgsl_drawobj *drawobj)
{
	...
	__maybe_unused struct adreno_context *drawctxt = ADRENO_CONTEXT(context);
...
static void retire_cmdobj(struct adreno_device *adreno_dev,
		struct kgsl_drawobj_cmd *cmdobj)
{
	__maybe_unused struct adreno_dispatcher *dispatcher = &adreno_dev->dispatcher;
	__maybe_unused struct kgsl_drawobj *drawobj = DRAWOBJ(cmdobj);
	__maybe_unused struct adreno_context *drawctxt = ADRENO_CONTEXT(drawobj->context);
